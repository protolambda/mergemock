...
// Hash: 171cd822103f579022105f258b8d9b8c34aceed6b6fd9c8ac2bd89925e920a45
package types
...
func (d *Deposit) UnmarshalSSZ(buf []byte) error {
	...
	// Field (2) 'Amount'
	d.Amount = hexutil.Uint64(ssz.UnmarshallUint64(buf[80:88]))
...
func (e *ExecutionPayloadHeaderV1) UnmarshalSSZ(buf []byte) error {
	...
	// Field (6) 'Number'
	e.Number = hexutil.Uint64(ssz.UnmarshallUint64(buf[404:412]))

	// Field (7) 'GasLimit'
	e.GasLimit = hexutil.Uint64(ssz.UnmarshallUint64(buf[412:420]))

	// Field (8) 'GasUsed'
	e.GasUsed = hexutil.Uint64(ssz.UnmarshallUint64(buf[420:428]))

	// Field (9) 'Timestamp'
	e.Timestamp = hexutil.Uint64(ssz.UnmarshallUint64(buf[428:436]))
